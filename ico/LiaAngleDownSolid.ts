...
/**
 * AngleDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAngleDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAngleDownSolid;
