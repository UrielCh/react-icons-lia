...
/**
 * ClipboardListSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaClipboardListSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaClipboardListSolid;
