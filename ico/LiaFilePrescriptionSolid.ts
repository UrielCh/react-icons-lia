...
/**
 * FilePrescriptionSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFilePrescriptionSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFilePrescriptionSolid;
