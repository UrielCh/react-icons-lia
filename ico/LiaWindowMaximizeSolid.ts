...
/**
 * WindowMaximizeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWindowMaximizeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWindowMaximizeSolid;
