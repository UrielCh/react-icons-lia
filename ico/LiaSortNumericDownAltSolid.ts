...
/**
 * SortNumericDownAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortNumericDownAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortNumericDownAltSolid;
