...
/**
 * GlassMartiniAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGlassMartiniAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGlassMartiniAltSolid;
