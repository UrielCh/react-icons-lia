...
/**
 * VolumeUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVolumeUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVolumeUpSolid;
