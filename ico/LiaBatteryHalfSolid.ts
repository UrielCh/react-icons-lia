...
/**
 * BatteryHalfSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBatteryHalfSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBatteryHalfSolid;
