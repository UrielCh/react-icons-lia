...
/**
 * AngleDoubleUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAngleDoubleUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAngleDoubleUpSolid;
