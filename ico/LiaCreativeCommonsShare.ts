...
/**
 * CreativeCommonsShare icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsShare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsShare;
