...
/**
 * HeadphonesAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHeadphonesAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHeadphonesAltSolid;
