...
/**
 * HospitalAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHospitalAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHospitalAltSolid;
