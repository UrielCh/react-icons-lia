...
/**
 * ToriiGateSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaToriiGateSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaToriiGateSolid;
