...
/**
 * SortDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortDownSolid;
