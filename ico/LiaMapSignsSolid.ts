...
/**
 * MapSignsSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMapSignsSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMapSignsSolid;
