...
/**
 * CaretSquareRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareRightSolid;
