...
/**
 * GrinSquintSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGrinSquintSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGrinSquintSolid;
