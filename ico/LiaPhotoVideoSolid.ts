...
/**
 * PhotoVideoSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPhotoVideoSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPhotoVideoSolid;
