...
/**
 * ReplyAllSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaReplyAllSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaReplyAllSolid;
