...
/**
 * ArrowCircleRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowCircleRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowCircleRightSolid;
