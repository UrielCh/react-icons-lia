...
/**
 * GrinBeamSweatSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGrinBeamSweatSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGrinBeamSweatSolid;
