...
/**
 * SwatchbookSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSwatchbookSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSwatchbookSolid;
