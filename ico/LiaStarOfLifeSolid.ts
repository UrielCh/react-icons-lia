...
/**
 * StarOfLifeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStarOfLifeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStarOfLifeSolid;
