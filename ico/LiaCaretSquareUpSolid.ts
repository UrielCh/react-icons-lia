...
/**
 * CaretSquareUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareUpSolid;
