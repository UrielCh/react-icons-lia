...
/**
 * StackOverflow icon from Icons8 Line Awesome
 * @module
 */
export function LiaStackOverflow(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStackOverflow;
