...
/**
 * SortAmountDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAmountDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAmountDownSolid;
