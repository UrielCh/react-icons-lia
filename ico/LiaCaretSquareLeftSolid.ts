...
/**
 * CaretSquareLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareLeftSolid;
