...
/**
 * TabletAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTabletAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTabletAltSolid;
