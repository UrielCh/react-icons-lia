...
/**
 * TerminalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTerminalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTerminalSolid;
