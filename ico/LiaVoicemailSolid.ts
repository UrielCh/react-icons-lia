...
/**
 * VoicemailSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVoicemailSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVoicemailSolid;
