...
/**
 * LaptopMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLaptopMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLaptopMedicalSolid;
