...
/**
 * ArrowsAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowsAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowsAltSolid;
