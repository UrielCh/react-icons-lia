...
/**
 * HourglassEndSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHourglassEndSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHourglassEndSolid;
