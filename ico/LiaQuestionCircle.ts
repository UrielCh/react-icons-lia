...
/**
 * QuestionCircle icon from Icons8 Line Awesome
 * @module
 */
export function LiaQuestionCircle(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaQuestionCircle;
