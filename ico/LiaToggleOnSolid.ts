...
/**
 * ToggleOnSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaToggleOnSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaToggleOnSolid;
