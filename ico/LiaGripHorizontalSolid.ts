...
/**
 * GripHorizontalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGripHorizontalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGripHorizontalSolid;
