...
/**
 * PoundSignSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPoundSignSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPoundSignSolid;
