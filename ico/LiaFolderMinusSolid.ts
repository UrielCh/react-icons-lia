...
/**
 * FolderMinusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFolderMinusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFolderMinusSolid;
