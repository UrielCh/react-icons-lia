...
/**
 * GlobeAfricaSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGlobeAfricaSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGlobeAfricaSolid;
