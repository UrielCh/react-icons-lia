...
/**
 * VectorSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVectorSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVectorSquareSolid;
