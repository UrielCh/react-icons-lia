...
/**
 * EnvelopeOpenSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEnvelopeOpenSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEnvelopeOpenSolid;
