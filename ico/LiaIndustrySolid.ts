...
/**
 * IndustrySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaIndustrySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaIndustrySolid;
