...
/**
 * CaretSquareRight icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareRight;
