...
/**
 * CreativeCommonsBy icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsBy(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsBy;
