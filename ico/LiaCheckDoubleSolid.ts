...
/**
 * CheckDoubleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCheckDoubleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCheckDoubleSolid;
