...
/**
 * KeyboardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaKeyboardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaKeyboardSolid;
