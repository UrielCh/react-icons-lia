...
/**
 * GrinTongueWink icon from Icons8 Line Awesome
 * @module
 */
export function LiaGrinTongueWink(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGrinTongueWink;
