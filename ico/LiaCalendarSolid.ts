...
/**
 * CalendarSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarSolid;
