...
/**
 * FileArchiveSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileArchiveSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileArchiveSolid;
