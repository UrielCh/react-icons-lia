...
/**
 * SearchDollarSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSearchDollarSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSearchDollarSolid;
