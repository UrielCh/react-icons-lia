...
/**
 * MailBulkSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMailBulkSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMailBulkSolid;
