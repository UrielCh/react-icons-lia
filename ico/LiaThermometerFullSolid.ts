...
/**
 * ThermometerFullSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaThermometerFullSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaThermometerFullSolid;
