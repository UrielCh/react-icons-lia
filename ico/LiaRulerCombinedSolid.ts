...
/**
 * RulerCombinedSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRulerCombinedSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRulerCombinedSolid;
