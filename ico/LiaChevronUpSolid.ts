...
/**
 * ChevronUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronUpSolid;
