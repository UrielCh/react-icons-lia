...
/**
 * TicketAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTicketAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTicketAltSolid;
