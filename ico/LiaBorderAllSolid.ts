...
/**
 * BorderAllSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBorderAllSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBorderAllSolid;
