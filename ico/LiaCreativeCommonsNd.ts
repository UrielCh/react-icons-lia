...
/**
 * CreativeCommonsNd icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsNd(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsNd;
