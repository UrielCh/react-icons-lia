...
/**
 * WarehouseSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWarehouseSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWarehouseSolid;
