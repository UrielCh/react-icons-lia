...
/**
 * EuroSignSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEuroSignSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEuroSignSolid;
