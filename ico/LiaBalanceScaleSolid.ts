...
/**
 * BalanceScaleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBalanceScaleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBalanceScaleSolid;
