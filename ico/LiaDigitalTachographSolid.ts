...
/**
 * DigitalTachographSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDigitalTachographSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDigitalTachographSolid;
