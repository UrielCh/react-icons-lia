...
/**
 * DatabaseSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDatabaseSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDatabaseSolid;
