...
/**
 * CommentMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCommentMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCommentMedicalSolid;
