...
/**
 * CameraRetroSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCameraRetroSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCameraRetroSolid;
