...
/**
 * DumpsterSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDumpsterSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDumpsterSolid;
