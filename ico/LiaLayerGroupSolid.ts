...
/**
 * LayerGroupSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLayerGroupSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLayerGroupSolid;
