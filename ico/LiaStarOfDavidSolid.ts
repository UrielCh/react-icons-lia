...
/**
 * StarOfDavidSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStarOfDavidSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStarOfDavidSolid;
