...
/**
 * FortAwesomeAlt icon from Icons8 Line Awesome
 * @module
 */
export function LiaFortAwesomeAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFortAwesomeAlt;
