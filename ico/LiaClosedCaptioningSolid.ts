...
/**
 * ClosedCaptioningSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaClosedCaptioningSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaClosedCaptioningSolid;
