...
/**
 * VolumeOffSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVolumeOffSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVolumeOffSolid;
