...
/**
 * ObjectUngroup icon from Icons8 Line Awesome
 * @module
 */
export function LiaObjectUngroup(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaObjectUngroup;
