...
/**
 * SortAmountDownAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAmountDownAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAmountDownAltSolid;
