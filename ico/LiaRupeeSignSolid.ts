...
/**
 * RupeeSignSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRupeeSignSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRupeeSignSolid;
