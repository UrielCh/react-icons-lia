...
/**
 * FileUploadSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileUploadSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileUploadSolid;
