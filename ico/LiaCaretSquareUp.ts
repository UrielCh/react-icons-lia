...
/**
 * CaretSquareUp icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareUp;
