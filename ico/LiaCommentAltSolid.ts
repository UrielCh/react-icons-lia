...
/**
 * CommentAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCommentAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCommentAltSolid;
