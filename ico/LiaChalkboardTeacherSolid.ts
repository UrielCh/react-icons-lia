...
/**
 * ChalkboardTeacherSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChalkboardTeacherSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChalkboardTeacherSolid;
