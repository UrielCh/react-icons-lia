...
/**
 * CommentsSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCommentsSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCommentsSolid;
