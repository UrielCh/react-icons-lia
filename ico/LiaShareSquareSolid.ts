...
/**
 * ShareSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaShareSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaShareSquareSolid;
