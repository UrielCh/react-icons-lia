...
/**
 * TemperatureLowSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTemperatureLowSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTemperatureLowSolid;
