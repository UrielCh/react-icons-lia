...
/**
 * HeadphonesSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHeadphonesSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHeadphonesSolid;
