...
/**
 * GrinBeamSweat icon from Icons8 Line Awesome
 * @module
 */
export function LiaGrinBeamSweat(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGrinBeamSweat;
