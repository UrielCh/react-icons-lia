...
/**
 * ObjectUngroupSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaObjectUngroupSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaObjectUngroupSolid;
