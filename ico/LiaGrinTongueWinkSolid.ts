...
/**
 * GrinTongueWinkSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGrinTongueWinkSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGrinTongueWinkSolid;
