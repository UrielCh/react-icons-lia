...
/**
 * ThermometerHalfSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaThermometerHalfSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaThermometerHalfSolid;
