...
/**
 * StarHalfSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStarHalfSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStarHalfSolid;
