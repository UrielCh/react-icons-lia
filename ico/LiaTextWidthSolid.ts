...
/**
 * TextWidthSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTextWidthSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTextWidthSolid;
