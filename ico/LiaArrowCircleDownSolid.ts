...
/**
 * ArrowCircleDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowCircleDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowCircleDownSolid;
