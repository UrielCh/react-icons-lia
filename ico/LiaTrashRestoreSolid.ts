...
/**
 * TrashRestoreSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTrashRestoreSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTrashRestoreSolid;
