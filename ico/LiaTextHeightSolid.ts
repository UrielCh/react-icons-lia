...
/**
 * TextHeightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTextHeightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTextHeightSolid;
