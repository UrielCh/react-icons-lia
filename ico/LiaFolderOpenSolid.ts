...
/**
 * FolderOpenSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFolderOpenSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFolderOpenSolid;
