...
/**
 * EllipsisHSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEllipsisHSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEllipsisHSolid;
