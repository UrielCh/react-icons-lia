...
/**
 * IdCardAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaIdCardAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaIdCardAltSolid;
