...
/**
 * CompressSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCompressSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCompressSolid;
