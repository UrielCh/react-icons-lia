...
/**
 * ArrowsAltHSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowsAltHSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowsAltHSolid;
