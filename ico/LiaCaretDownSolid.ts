...
/**
 * CaretDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretDownSolid;
