...
/**
 * CompressArrowsAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCompressArrowsAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCompressArrowsAltSolid;
