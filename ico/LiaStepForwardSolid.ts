...
/**
 * StepForwardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStepForwardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStepForwardSolid;
