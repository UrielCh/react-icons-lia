...
/**
 * ChevronRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronRightSolid;
