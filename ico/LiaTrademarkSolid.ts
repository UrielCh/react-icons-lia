...
/**
 * TrademarkSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTrademarkSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTrademarkSolid;
