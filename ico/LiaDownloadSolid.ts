...
/**
 * DownloadSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDownloadSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDownloadSolid;
