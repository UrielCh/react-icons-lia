...
/**
 * TransgenderSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTransgenderSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTransgenderSolid;
