...
/**
 * FastBackwardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFastBackwardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFastBackwardSolid;
