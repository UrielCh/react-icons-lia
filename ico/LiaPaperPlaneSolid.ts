...
/**
 * PaperPlaneSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPaperPlaneSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPaperPlaneSolid;
