...
/**
 * ClipboardCheckSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaClipboardCheckSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaClipboardCheckSolid;
