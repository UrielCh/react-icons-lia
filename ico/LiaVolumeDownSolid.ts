...
/**
 * VolumeDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVolumeDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVolumeDownSolid;
