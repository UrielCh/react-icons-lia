...
/**
 * WindowCloseSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWindowCloseSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWindowCloseSolid;
