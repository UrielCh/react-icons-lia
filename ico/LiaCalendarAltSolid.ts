...
/**
 * CalendarAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarAltSolid;
