...
/**
 * DiceFourSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDiceFourSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDiceFourSolid;
