...
/**
 * RulerHorizontalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRulerHorizontalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRulerHorizontalSolid;
