...
/**
 * PlayCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPlayCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPlayCircleSolid;
