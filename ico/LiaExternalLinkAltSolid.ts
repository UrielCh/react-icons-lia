...
/**
 * ExternalLinkAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExternalLinkAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExternalLinkAltSolid;
