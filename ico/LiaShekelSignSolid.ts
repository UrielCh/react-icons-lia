...
/**
 * ShekelSignSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaShekelSignSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaShekelSignSolid;
