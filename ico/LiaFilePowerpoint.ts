...
/**
 * FilePowerpoint icon from Icons8 Line Awesome
 * @module
 */
export function LiaFilePowerpoint(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFilePowerpoint;
