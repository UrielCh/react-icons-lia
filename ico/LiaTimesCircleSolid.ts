...
/**
 * TimesCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTimesCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTimesCircleSolid;
