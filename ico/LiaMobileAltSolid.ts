...
/**
 * MobileAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMobileAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMobileAltSolid;
