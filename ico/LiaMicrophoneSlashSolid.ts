...
/**
 * MicrophoneSlashSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMicrophoneSlashSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMicrophoneSlashSolid;
