...
/**
 * AlignCenterSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAlignCenterSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAlignCenterSolid;
