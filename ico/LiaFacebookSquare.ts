...
/**
 * FacebookSquare icon from Icons8 Line Awesome
 * @module
 */
export function LiaFacebookSquare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFacebookSquare;
