...
/**
 * SearchMinusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSearchMinusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSearchMinusSolid;
