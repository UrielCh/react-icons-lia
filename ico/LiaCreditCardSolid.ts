...
/**
 * CreditCardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreditCardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreditCardSolid;
