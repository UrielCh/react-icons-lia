...
/**
 * LandmarkSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLandmarkSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLandmarkSolid;
