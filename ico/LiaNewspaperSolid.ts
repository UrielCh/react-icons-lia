...
/**
 * NewspaperSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaNewspaperSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaNewspaperSolid;
