...
/**
 * SignInAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSignInAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSignInAltSolid;
