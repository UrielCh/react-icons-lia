...
/**
 * SuitcaseRollingSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSuitcaseRollingSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSuitcaseRollingSolid;
