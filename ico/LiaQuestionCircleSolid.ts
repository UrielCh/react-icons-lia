...
/**
 * QuestionCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaQuestionCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaQuestionCircleSolid;
