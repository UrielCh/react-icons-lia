...
/**
 * QuoteLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaQuoteLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaQuoteLeftSolid;
