...
/**
 * CircleNotchSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCircleNotchSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCircleNotchSolid;
