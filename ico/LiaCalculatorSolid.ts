...
/**
 * CalculatorSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalculatorSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalculatorSolid;
