...
/**
 * HospitalSymbolSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHospitalSymbolSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHospitalSymbolSolid;
