...
/**
 * ClinicMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaClinicMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaClinicMedicalSolid;
