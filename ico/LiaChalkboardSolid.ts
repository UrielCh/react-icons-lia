...
/**
 * ChalkboardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChalkboardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChalkboardSolid;
