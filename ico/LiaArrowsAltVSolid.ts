...
/**
 * ArrowsAltVSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowsAltVSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowsAltVSolid;
