...
/**
 * PlaceOfWorshipSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPlaceOfWorshipSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPlaceOfWorshipSolid;
