...
/**
 * BriefcaseSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBriefcaseSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBriefcaseSolid;
