...
/**
 * ExclamationSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExclamationSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExclamationSolid;
