...
/**
 * CalendarDaySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarDaySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarDaySolid;
