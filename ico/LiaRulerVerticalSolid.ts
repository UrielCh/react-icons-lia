...
/**
 * RulerVerticalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRulerVerticalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRulerVerticalSolid;
