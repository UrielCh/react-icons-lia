...
/**
 * SortAlphaUpAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAlphaUpAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAlphaUpAltSolid;
