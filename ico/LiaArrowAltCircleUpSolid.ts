...
/**
 * ArrowAltCircleUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleUpSolid;
