...
/**
 * SortAmountUpAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAmountUpAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAmountUpAltSolid;
