...
/**
 * LevelDownAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLevelDownAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLevelDownAltSolid;
