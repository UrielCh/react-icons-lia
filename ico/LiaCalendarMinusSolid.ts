...
/**
 * CalendarMinusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarMinusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarMinusSolid;
