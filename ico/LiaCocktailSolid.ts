...
/**
 * CocktailSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCocktailSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCocktailSolid;
