...
/**
 * HackerNewsSquare icon from Icons8 Line Awesome
 * @module
 */
export function LiaHackerNewsSquare(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHackerNewsSquare;
