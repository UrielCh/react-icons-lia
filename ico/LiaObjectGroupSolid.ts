...
/**
 * ObjectGroupSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaObjectGroupSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaObjectGroupSolid;
