...
/**
 * FileMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileMedicalSolid;
