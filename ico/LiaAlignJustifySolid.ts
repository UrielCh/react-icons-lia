...
/**
 * AlignJustifySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAlignJustifySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAlignJustifySolid;
