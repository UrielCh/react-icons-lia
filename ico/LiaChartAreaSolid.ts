...
/**
 * ChartAreaSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChartAreaSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChartAreaSolid;
