...
/**
 * ExclamationCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExclamationCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExclamationCircleSolid;
