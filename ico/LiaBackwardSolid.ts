...
/**
 * BackwardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBackwardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBackwardSolid;
