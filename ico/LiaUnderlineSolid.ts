...
/**
 * UnderlineSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaUnderlineSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaUnderlineSolid;
