...
/**
 * SearchPlusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSearchPlusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSearchPlusSolid;
