...
/**
 * WindowMaximize icon from Icons8 Line Awesome
 * @module
 */
export function LiaWindowMaximize(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWindowMaximize;
