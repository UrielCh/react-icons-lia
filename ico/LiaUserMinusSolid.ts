...
/**
 * UserMinusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaUserMinusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaUserMinusSolid;
