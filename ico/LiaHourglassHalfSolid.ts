...
/**
 * HourglassHalfSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHourglassHalfSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHourglassHalfSolid;
