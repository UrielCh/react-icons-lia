...
/**
 * StepBackwardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStepBackwardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStepBackwardSolid;
