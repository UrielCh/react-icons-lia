...
/**
 * ChessBoardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChessBoardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChessBoardSolid;
