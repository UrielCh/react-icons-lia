...
/**
 * FilePowerpointSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFilePowerpointSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFilePowerpointSolid;
