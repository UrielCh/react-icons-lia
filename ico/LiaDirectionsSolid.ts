...
/**
 * DirectionsSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDirectionsSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDirectionsSolid;
