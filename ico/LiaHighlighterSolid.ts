...
/**
 * HighlighterSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHighlighterSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHighlighterSolid;
