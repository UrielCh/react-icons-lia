...
/**
 * FileVideoSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileVideoSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileVideoSolid;
