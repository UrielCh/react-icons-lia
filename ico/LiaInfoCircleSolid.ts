...
/**
 * InfoCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaInfoCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaInfoCircleSolid;
