...
/**
 * MehBlankSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMehBlankSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMehBlankSolid;
