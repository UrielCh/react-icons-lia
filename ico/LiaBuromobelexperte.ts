...
/**
 * Buromobelexperte icon from Icons8 Line Awesome
 * @module
 */
export function LiaBuromobelexperte(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBuromobelexperte;
