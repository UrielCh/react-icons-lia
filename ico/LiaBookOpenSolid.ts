...
/**
 * BookOpenSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBookOpenSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBookOpenSolid;
