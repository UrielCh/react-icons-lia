...
/**
 * ChevronCircleLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronCircleLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronCircleLeftSolid;
