...
/**
 * CommentDotsSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCommentDotsSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCommentDotsSolid;
