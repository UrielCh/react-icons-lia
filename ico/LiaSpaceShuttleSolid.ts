...
/**
 * SpaceShuttleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSpaceShuttleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSpaceShuttleSolid;
