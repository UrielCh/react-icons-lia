...
/**
 * CommentSlashSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCommentSlashSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCommentSlashSolid;
