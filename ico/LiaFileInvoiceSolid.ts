...
/**
 * FileInvoiceSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileInvoiceSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileInvoiceSolid;
