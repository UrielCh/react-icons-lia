...
/**
 * PrescriptionSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPrescriptionSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPrescriptionSolid;
