...
/**
 * TransgenderAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTransgenderAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTransgenderAltSolid;
