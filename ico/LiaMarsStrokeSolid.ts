...
/**
 * MarsStrokeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMarsStrokeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMarsStrokeSolid;
