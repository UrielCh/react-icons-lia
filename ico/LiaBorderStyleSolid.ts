...
/**
 * BorderStyleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBorderStyleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBorderStyleSolid;
