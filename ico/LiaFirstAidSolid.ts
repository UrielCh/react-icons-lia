...
/**
 * FirstAidSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFirstAidSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFirstAidSolid;
