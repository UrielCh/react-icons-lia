...
/**
 * CalendarWeekSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarWeekSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarWeekSolid;
