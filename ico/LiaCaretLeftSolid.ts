...
/**
 * CaretLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretLeftSolid;
