...
/**
 * BriefcaseMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBriefcaseMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBriefcaseMedicalSolid;
