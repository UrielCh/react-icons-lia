...
/**
 * ArrowAltCircleUp icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleUp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleUp;
