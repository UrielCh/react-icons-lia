...
/**
 * PlusSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPlusSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPlusSquareSolid;
