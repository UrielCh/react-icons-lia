...
/**
 * MarsStrokeHSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMarsStrokeHSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMarsStrokeHSolid;
