...
/**
 * CaretRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretRightSolid;
