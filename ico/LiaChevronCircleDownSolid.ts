...
/**
 * ChevronCircleDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronCircleDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronCircleDownSolid;
