...
/**
 * BatteryQuarterSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBatteryQuarterSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBatteryQuarterSolid;
