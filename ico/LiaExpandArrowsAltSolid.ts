...
/**
 * ExpandArrowsAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExpandArrowsAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExpandArrowsAltSolid;
