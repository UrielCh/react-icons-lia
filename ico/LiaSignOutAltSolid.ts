...
/**
 * SignOutAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSignOutAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSignOutAltSolid;
