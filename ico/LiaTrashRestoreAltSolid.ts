...
/**
 * TrashRestoreAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTrashRestoreAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTrashRestoreAltSolid;
