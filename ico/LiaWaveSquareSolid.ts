...
/**
 * WaveSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWaveSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWaveSquareSolid;
