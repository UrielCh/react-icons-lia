...
/**
 * CarBatterySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCarBatterySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCarBatterySolid;
