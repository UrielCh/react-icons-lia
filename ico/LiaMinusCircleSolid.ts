...
/**
 * MinusCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMinusCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMinusCircleSolid;
