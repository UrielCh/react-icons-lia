...
/**
 * ChevronDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronDownSolid;
