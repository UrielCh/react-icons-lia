...
/**
 * PrescriptionBottleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPrescriptionBottleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPrescriptionBottleSolid;
