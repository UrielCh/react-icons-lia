...
/**
 * RemoveFormatSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRemoveFormatSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRemoveFormatSolid;
