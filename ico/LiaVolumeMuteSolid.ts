...
/**
 * VolumeMuteSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVolumeMuteSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVolumeMuteSolid;
