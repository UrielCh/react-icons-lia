...
/**
 * DraftingCompassSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDraftingCompassSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDraftingCompassSolid;
