...
/**
 * QuoteRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaQuoteRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaQuoteRightSolid;
