...
/**
 * CreativeCommonsRemix icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsRemix(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsRemix;
