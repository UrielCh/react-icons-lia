...
/**
 * SearchLocationSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSearchLocationSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSearchLocationSolid;
