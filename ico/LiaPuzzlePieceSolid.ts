...
/**
 * PuzzlePieceSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPuzzlePieceSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPuzzlePieceSolid;
