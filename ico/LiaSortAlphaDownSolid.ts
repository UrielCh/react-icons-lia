...
/**
 * SortAlphaDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAlphaDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAlphaDownSolid;
