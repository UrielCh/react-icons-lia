...
/**
 * BreadSliceSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBreadSliceSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBreadSliceSolid;
