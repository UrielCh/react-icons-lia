...
/**
 * ClosedCaptioning icon from Icons8 Line Awesome
 * @module
 */
export function LiaClosedCaptioning(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaClosedCaptioning;
