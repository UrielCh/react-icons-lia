...
/**
 * BatteryFullSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBatteryFullSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBatteryFullSolid;
