...
/**
 * ThermometerThreeQuartersSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaThermometerThreeQuartersSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaThermometerThreeQuartersSolid;
