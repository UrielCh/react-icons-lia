...
/**
 * RubleSignSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRubleSignSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRubleSignSolid;
