...
/**
 * ThermometerEmptySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaThermometerEmptySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaThermometerEmptySolid;
