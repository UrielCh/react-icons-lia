...
/**
 * CalendarPlusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarPlusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarPlusSolid;
