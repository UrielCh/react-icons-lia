...
/**
 * ExternalLinkSquareAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExternalLinkSquareAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExternalLinkSquareAltSolid;
