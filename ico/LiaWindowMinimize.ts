...
/**
 * WindowMinimize icon from Icons8 Line Awesome
 * @module
 */
export function LiaWindowMinimize(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWindowMinimize;
