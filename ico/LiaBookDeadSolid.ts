...
/**
 * BookDeadSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBookDeadSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBookDeadSolid;
