...
/**
 * FileMedicalAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileMedicalAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileMedicalAltSolid;
