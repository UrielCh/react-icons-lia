...
/**
 * ChevronCircleUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronCircleUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronCircleUpSolid;
