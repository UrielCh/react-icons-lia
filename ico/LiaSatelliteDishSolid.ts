...
/**
 * SatelliteDishSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSatelliteDishSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSatelliteDishSolid;
