...
/**
 * MicrophoneAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMicrophoneAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMicrophoneAltSolid;
