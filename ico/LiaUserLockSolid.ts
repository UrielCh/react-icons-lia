...
/**
 * UserLockSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaUserLockSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaUserLockSolid;
