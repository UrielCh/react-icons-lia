...
/**
 * StarHalfAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStarHalfAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStarHalfAltSolid;
