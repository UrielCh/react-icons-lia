...
/**
 * CreativeCommonsSa icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsSa(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsSa;
