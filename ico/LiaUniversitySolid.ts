...
/**
 * UniversitySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaUniversitySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaUniversitySolid;
