...
/**
 * LuggageCartSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLuggageCartSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLuggageCartSolid;
