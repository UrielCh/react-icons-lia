...
/**
 * HospitalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHospitalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHospitalSolid;
