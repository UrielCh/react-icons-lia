...
/**
 * SuitcaseSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSuitcaseSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSuitcaseSolid;
