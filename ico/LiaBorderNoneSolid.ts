...
/**
 * BorderNoneSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBorderNoneSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBorderNoneSolid;
