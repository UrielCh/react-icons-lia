...
/**
 * CreativeCommonsNcJp icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsNcJp(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsNcJp;
