...
/**
 * HourglassSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHourglassSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHourglassSolid;
