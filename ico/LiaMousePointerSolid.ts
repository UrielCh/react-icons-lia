...
/**
 * MousePointerSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMousePointerSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMousePointerSolid;
