...
/**
 * PauseCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPauseCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPauseCircleSolid;
