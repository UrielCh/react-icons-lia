...
/**
 * SortNumericDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortNumericDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortNumericDownSolid;
