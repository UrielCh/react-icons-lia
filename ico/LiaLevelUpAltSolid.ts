...
/**
 * LevelUpAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLevelUpAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLevelUpAltSolid;
