...
/**
 * SortAlphaUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAlphaUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAlphaUpSolid;
