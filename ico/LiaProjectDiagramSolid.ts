...
/**
 * ProjectDiagramSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaProjectDiagramSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaProjectDiagramSolid;
