...
/**
 * ChargingStationSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChargingStationSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChargingStationSolid;
