...
/**
 * SortAlphaDownAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAlphaDownAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAlphaDownAltSolid;
