...
/**
 * ArrowAltCircleDown icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleDown;
