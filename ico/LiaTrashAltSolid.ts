...
/**
 * TrashAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTrashAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTrashAltSolid;
