...
/**
 * FacebookMessenger icon from Icons8 Line Awesome
 * @module
 */
export function LiaFacebookMessenger(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFacebookMessenger;
