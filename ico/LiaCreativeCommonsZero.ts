...
/**
 * CreativeCommonsZero icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsZero(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsZero;
