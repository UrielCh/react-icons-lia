...
/**
 * ThermometerQuarterSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaThermometerQuarterSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaThermometerQuarterSolid;
