...
/**
 * CaretSquareDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareDownSolid;
