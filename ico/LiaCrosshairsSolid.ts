...
/**
 * CrosshairsSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCrosshairsSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCrosshairsSolid;
