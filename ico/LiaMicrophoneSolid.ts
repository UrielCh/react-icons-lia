...
/**
 * MicrophoneSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMicrophoneSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMicrophoneSolid;
