...
/**
 * FastForwardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFastForwardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFastForwardSolid;
