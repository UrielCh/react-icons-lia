...
/**
 * StackExchange icon from Icons8 Line Awesome
 * @module
 */
export function LiaStackExchange(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStackExchange;
