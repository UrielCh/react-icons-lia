...
/**
 * FolderPlusSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFolderPlusSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFolderPlusSolid;
