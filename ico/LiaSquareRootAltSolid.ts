...
/**
 * SquareRootAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSquareRootAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSquareRootAltSolid;
