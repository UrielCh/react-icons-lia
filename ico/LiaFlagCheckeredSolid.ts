...
/**
 * FlagCheckeredSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFlagCheckeredSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFlagCheckeredSolid;
