...
/**
 * FileExcelSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileExcelSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileExcelSolid;
