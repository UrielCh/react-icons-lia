...
/**
 * ArrowAltCircleLeft icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleLeft(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleLeft;
