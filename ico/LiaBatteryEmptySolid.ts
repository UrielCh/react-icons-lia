...
/**
 * BatteryEmptySolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBatteryEmptySolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBatteryEmptySolid;
