...
/**
 * EllipsisVSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEllipsisVSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEllipsisVSolid;
