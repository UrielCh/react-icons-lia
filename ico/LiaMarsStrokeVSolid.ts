...
/**
 * MarsStrokeVSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMarsStrokeVSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMarsStrokeVSolid;
