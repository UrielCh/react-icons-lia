...
/**
 * ArrowAltCircleLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleLeftSolid;
