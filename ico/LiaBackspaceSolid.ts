...
/**
 * BackspaceSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBackspaceSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBackspaceSolid;
