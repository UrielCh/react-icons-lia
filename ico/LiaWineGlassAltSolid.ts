...
/**
 * WineGlassAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWineGlassAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWineGlassAltSolid;
