...
/**
 * SpellCheckSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSpellCheckSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSpellCheckSolid;
