...
/**
 * NetworkWiredSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaNetworkWiredSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaNetworkWiredSolid;
