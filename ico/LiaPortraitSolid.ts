...
/**
 * PortraitSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPortraitSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPortraitSolid;
