...
/**
 * ArrowRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowRightSolid;
