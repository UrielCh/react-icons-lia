...
/**
 * FileImageSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileImageSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileImageSolid;
