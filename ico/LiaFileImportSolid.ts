...
/**
 * FileImportSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileImportSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileImportSolid;
