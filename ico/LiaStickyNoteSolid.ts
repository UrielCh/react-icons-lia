...
/**
 * StickyNoteSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStickyNoteSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStickyNoteSolid;
