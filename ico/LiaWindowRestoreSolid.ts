...
/**
 * WindowRestoreSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWindowRestoreSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWindowRestoreSolid;
