...
/**
 * MoneyBillAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMoneyBillAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMoneyBillAltSolid;
