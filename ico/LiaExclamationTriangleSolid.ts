...
/**
 * ExclamationTriangleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExclamationTriangleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExclamationTriangleSolid;
