...
/**
 * RegisteredSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaRegisteredSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaRegisteredSolid;
