...
/**
 * NotEqualSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaNotEqualSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaNotEqualSolid;
