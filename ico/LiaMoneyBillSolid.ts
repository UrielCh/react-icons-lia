...
/**
 * MoneyBillSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMoneyBillSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMoneyBillSolid;
