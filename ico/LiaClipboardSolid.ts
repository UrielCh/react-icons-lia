...
/**
 * ClipboardSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaClipboardSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaClipboardSolid;
