...
/**
 * PrescriptionBottleAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPrescriptionBottleAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPrescriptionBottleAltSolid;
