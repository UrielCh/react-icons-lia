...
/**
 * CalendarCheckSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarCheckSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarCheckSolid;
