...
/**
 * LessThanEqualSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLessThanEqualSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLessThanEqualSolid;
