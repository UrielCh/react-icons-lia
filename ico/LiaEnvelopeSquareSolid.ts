...
/**
 * EnvelopeSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEnvelopeSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEnvelopeSquareSolid;
