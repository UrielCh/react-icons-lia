...
/**
 * ThumbtackSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaThumbtackSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaThumbtackSolid;
