...
/**
 * SortAmountUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaSortAmountUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaSortAmountUpSolid;
