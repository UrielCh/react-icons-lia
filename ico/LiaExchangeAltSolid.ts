...
/**
 * ExchangeAltSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaExchangeAltSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaExchangeAltSolid;
