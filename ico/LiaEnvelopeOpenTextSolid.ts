...
/**
 * EnvelopeOpenTextSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEnvelopeOpenTextSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEnvelopeOpenTextSolid;
