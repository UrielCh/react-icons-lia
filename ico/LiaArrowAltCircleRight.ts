...
/**
 * ArrowAltCircleRight icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleRight(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleRight;
