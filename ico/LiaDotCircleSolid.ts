...
/**
 * DotCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDotCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDotCircleSolid;
