...
/**
 * StopCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaStopCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaStopCircleSolid;
