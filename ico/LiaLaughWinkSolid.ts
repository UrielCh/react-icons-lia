...
/**
 * LaughWinkSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLaughWinkSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLaughWinkSolid;
