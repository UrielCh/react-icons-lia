...
/**
 * LockOpenSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLockOpenSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLockOpenSolid;
