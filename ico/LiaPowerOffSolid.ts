...
/**
 * PowerOffSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPowerOffSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPowerOffSolid;
