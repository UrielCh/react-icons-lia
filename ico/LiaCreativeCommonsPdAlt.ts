...
/**
 * CreativeCommonsPdAlt icon from Icons8 Line Awesome
 * @module
 */
export function LiaCreativeCommonsPdAlt(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCreativeCommonsPdAlt;
