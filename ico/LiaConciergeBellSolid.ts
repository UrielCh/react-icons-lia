...
/**
 * ConciergeBellSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaConciergeBellSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaConciergeBellSolid;
