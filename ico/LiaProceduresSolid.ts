...
/**
 * ProceduresSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaProceduresSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaProceduresSolid;
