...
/**
 * CaretSquareDown icon from Icons8 Line Awesome
 * @module
 */
export function LiaCaretSquareDown(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCaretSquareDown;
