...
/**
 * EnvelopeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaEnvelopeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaEnvelopeSolid;
