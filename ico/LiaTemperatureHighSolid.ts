...
/**
 * TemperatureHighSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTemperatureHighSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTemperatureHighSolid;
