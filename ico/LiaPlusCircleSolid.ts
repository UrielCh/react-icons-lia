...
/**
 * PlusCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPlusCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPlusCircleSolid;
