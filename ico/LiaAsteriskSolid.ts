...
/**
 * AsteriskSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAsteriskSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAsteriskSolid;
