...
/**
 * MonumentSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMonumentSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMonumentSolid;
