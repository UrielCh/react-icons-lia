...
/**
 * TruckLoadingSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaTruckLoadingSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaTruckLoadingSolid;
