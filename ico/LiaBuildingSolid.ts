...
/**
 * BuildingSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBuildingSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBuildingSolid;
