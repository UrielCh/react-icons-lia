...
/**
 * DiceFiveSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDiceFiveSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDiceFiveSolid;
