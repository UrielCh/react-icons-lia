...
/**
 * CalendarCheck icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarCheck(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarCheck;
