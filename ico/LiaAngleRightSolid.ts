...
/**
 * AngleRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAngleRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAngleRightSolid;
