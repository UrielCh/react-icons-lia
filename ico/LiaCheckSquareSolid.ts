...
/**
 * CheckSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCheckSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCheckSquareSolid;
