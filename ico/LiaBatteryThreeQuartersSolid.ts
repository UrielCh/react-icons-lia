...
/**
 * BatteryThreeQuartersSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBatteryThreeQuartersSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBatteryThreeQuartersSolid;
