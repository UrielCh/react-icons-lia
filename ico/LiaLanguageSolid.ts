...
/**
 * LanguageSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLanguageSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLanguageSolid;
