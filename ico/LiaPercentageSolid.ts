...
/**
 * PercentageSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPercentageSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPercentageSolid;
