...
/**
 * FileDownloadSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileDownloadSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileDownloadSolid;
