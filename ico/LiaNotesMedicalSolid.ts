...
/**
 * NotesMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaNotesMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaNotesMedicalSolid;
