...
/**
 * CheckCircleSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCheckCircleSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCheckCircleSolid;
