...
/**
 * ChevronLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronLeftSolid;
