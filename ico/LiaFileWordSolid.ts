...
/**
 * FileWordSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileWordSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileWordSolid;
