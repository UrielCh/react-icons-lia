...
/**
 * DoorClosedSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDoorClosedSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDoorClosedSolid;
