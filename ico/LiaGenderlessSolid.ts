...
/**
 * GenderlessSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGenderlessSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGenderlessSolid;
