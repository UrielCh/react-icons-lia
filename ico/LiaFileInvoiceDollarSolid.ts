...
/**
 * FileInvoiceDollarSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileInvoiceDollarSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileInvoiceDollarSolid;
