...
/**
 * ChevronCircleRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChevronCircleRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChevronCircleRightSolid;
