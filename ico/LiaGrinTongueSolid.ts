...
/**
 * GrinTongueSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGrinTongueSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGrinTongueSolid;
