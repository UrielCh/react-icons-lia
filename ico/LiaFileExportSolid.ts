...
/**
 * FileExportSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileExportSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileExportSolid;
