...
/**
 * GlassMartiniSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGlassMartiniSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGlassMartiniSolid;
