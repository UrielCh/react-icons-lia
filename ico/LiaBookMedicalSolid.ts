...
/**
 * BookMedicalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBookMedicalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBookMedicalSolid;
