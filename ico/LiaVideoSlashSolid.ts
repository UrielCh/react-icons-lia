...
/**
 * VideoSlashSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaVideoSlashSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaVideoSlashSolid;
