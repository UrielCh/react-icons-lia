...
/**
 * FileCodeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileCodeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileCodeSolid;
