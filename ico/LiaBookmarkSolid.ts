...
/**
 * BookmarkSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBookmarkSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBookmarkSolid;
