...
/**
 * ArrowCircleUpSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowCircleUpSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowCircleUpSolid;
