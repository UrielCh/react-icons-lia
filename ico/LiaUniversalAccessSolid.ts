...
/**
 * UniversalAccessSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaUniversalAccessSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaUniversalAccessSolid;
