...
/**
 * HourglassStartSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHourglassStartSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHourglassStartSolid;
