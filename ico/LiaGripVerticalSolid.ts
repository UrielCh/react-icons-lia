...
/**
 * GripVerticalSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaGripVerticalSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaGripVerticalSolid;
