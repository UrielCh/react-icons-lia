...
/**
 * HouseDamageSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaHouseDamageSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaHouseDamageSolid;
