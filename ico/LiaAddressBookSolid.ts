...
/**
 * AddressBookSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaAddressBookSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaAddressBookSolid;
