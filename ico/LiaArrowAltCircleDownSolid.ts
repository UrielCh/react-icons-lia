...
/**
 * ArrowAltCircleDownSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleDownSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleDownSolid;
