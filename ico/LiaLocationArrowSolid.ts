...
/**
 * LocationArrowSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLocationArrowSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLocationArrowSolid;
