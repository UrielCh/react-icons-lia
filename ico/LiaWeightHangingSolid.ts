...
/**
 * WeightHangingSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaWeightHangingSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWeightHangingSolid;
