...
/**
 * PaintRollerSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaPaintRollerSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaPaintRollerSolid;
