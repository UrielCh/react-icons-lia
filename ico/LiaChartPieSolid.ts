...
/**
 * ChartPieSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChartPieSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChartPieSolid;
