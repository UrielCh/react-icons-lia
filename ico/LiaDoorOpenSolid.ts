...
/**
 * DoorOpenSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDoorOpenSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDoorOpenSolid;
