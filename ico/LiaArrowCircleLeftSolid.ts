...
/**
 * ArrowCircleLeftSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowCircleLeftSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowCircleLeftSolid;
