...
/**
 * CalendarTimesSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarTimesSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarTimesSolid;
