...
/**
 * CalendarMinus icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarMinus(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarMinus;
