...
/**
 * ArrowAltCircleRightSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaArrowAltCircleRightSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaArrowAltCircleRightSolid;
