...
/**
 * ParagraphSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaParagraphSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaParagraphSolid;
