...
/**
 * ChartBarSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaChartBarSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaChartBarSolid;
