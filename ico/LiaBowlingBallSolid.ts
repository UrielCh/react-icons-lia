...
/**
 * BowlingBallSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaBowlingBallSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaBowlingBallSolid;
