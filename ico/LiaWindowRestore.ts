...
/**
 * WindowRestore icon from Icons8 Line Awesome
 * @module
 */
export function LiaWindowRestore(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaWindowRestore;
