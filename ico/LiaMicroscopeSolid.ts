...
/**
 * MicroscopeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaMicroscopeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaMicroscopeSolid;
