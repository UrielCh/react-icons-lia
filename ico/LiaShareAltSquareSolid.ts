...
/**
 * ShareAltSquareSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaShareAltSquareSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaShareAltSquareSolid;
