...
/**
 * CalendarTimes icon from Icons8 Line Awesome
 * @module
 */
export function LiaCalendarTimes(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaCalendarTimes;
