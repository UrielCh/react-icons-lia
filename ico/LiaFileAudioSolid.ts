...
/**
 * FileAudioSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaFileAudioSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaFileAudioSolid;
