...
/**
 * LiraSignSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLiraSignSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLiraSignSolid;
