...
/**
 * DiceThreeSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaDiceThreeSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaDiceThreeSolid;
