...
/**
 * ShoppingBasketSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaShoppingBasketSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaShoppingBasketSolid;
