...
/**
 * LaughSquintSolid icon from Icons8 Line Awesome
 * @module
 */
export function LiaLaughSquintSolid(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default LiaLaughSquintSolid;
